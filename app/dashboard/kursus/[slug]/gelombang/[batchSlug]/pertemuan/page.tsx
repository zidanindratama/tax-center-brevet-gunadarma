...
import PertemuanDatatable from "@/components/(dashboard)/kursus/gelombang/pertemuan/pertemuan-datatable";
  ...
  return (
    <section>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        ...
        <Suspense>
          <PertemuanDatatable courseSlug={courseSlug} batchSlug={batchSlug} />
        </Suspense>
      </div>
    </section>
  );

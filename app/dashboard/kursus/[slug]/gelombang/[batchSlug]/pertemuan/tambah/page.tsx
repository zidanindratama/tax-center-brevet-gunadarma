...
import MeetingFormCreate from "@/components/(dashboard)/kursus/gelombang/pertemuan/pertemuan-form-create";

const DashboardTambahPertemuanPage = () => {
...
export default DashboardTambahPertemuanPage;

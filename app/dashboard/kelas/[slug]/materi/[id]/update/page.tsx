...
import MateriFormUpdate from "@/components/(dashboard)/kelas/materi/materi-form-update";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
const DashboardMaterialUpdatePage = () => {
...
export default DashboardMaterialUpdatePage;

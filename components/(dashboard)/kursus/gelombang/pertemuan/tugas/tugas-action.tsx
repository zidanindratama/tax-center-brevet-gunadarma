...
export function TugasAction({ assignmentId }: Props) {
  ...
  const deleteTugas = useDeleteData({
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem asChild>
            <Link
              href={`/dashboard/kursus/${courseSlug}/gelombang/${batchSlug}/pertemuan/${meetingId}/tugas/${assignmentId}/update`}
            >
              Ubah Data
            </Link>
          </DropdownMenuItem>
